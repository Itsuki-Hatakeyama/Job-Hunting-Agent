...

{
  ...
  "event_type": "イベント種別。必ず以下の【選択肢】の中から最も適切なものを1つだけ選び、完全一致で出力してください。独自の言葉を作ってはいけません。\n\n【選択肢】:\n\"1次面接\", \"2次面接\", \"3次面接\", \"最終面接\", \"面談\",\n\"グループディスカッション\", \"インターンシップ\",\n\"会社説明会\", \"合同説明会\", \"座談会\", \"セミナー\", \"OB訪問\",\n\"ES締切\", \"Webテスト締切\", \"書類提出締切\", \"適性検査\",\n\"書類選考通過\", \"内定通知\", \"お見送り通知\", \"その他\"\n\n【最重要ルール1 - お見送り・不採用】\nメール本文または件名に「貴意に沿いかねる」「ご希望に添えない」「ご縁がありませんでした」「今後のご活躍をお祈り」「採用を見送る」「不採用」「お見送り」「選考を終了」「選考通過が叶わ」「残念ながら」のいずれかが含まれる場合は、必ず \"お見送り通知\" を選んでください。\n\n【最重要ルール2 - 内定・内々定】\nメール本文または件名に「内定」「内々定」「採用決定」のいずれかが含まれる場合は、必ず \"内定通知\" を選んでください。\n\n上記のどれにも当てはまらない場合は \"その他\" を選んでください。",
  "start_datetime": "開始日時または締切日時（ISO 8601形式 例: 2026-05-20T14:00:00+09:00。不明な場合はnull。お見送り・内定通知の場合はnullで可）",
  "end_datetime": "終了日時（ISO 8601形式。明記されていない場合はnull）",
  "is_todo": "このメールがユーザーが期限内にアクションを完了する必要がある「提出物・タスク」かどうか。ES提出・Webテスト受験・書類提出・エントリー締切など該当する場合は true。面接・説明会など参加型イベント、およびお見送り・内定などの結果通知の場合は false"
}"""
